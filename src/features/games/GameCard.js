...
export default function GameCard({ game }) {
  return (
    <div className="flex items-center rounded-lg dark:bg-slate-700 p-2 shadow-xl hover:shadow-slate-700/50 transition-shadow cursor-pointer">
      {/* aspect-square object-none w-1/5 */}
      <div className="w-20">
