...
import { onNextPage, onPageChange, onPrevPage } from '../features/pagination/paginationSlice';

const visiblePages = 3;
const siblingCount = 1;

export default function Pagination2({ pages }) {
  ...
  return (
    <div className="flex justify-center mt-10">
      ...
      <button className="h-10 w-10 rounded-lg font-bold bg-sky-300/75 border border-sky-300/75 mx-1 transition-colors hover:bg-sky-500/75 hover:border-sky-500-75 hover:cursor-pointer focus:bg-sky-500/75 focus:border-sky-500-75 disabled:cursor-default disabled:bg-sky-300/75 disabled:text-slate-600" 
